...
```php
//...
use srag\ActiveRecordConfig\SrPluginGenerator\ActiveRecordConfigGUI;
//...
...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\SrPluginGenerator\ActiveRecordConfigFormGUI;
//...
...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\SrPluginGenerator\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\SrPluginGenerator\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\SrPluginGenerator\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
