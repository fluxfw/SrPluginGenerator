...
use ilSession;
use ilUtil;
use srag\DIC\SrPluginGenerator\DICStatic;
 ...
 *
 * @ilCtrl_isCalledBy srag\RemovePluginDataConfirm\SrPluginGenerator\RemovePluginDataConfirmCtrl: ilUIPluginRouterGUI
 */
class RemovePluginDataConfirmCtrl
{
