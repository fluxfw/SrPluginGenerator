...
```php
//...
use srag\RemovePluginDataConfirm\SrPluginGenerator\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\SrPluginGenerator\x\RepositoryObjectPluginUninstallTrait;
//...
